...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/new_184x256/184x256__train_clamped2_33242_6day.json',
    ...
    val=dict(
        type='TopDownCocoDataset',
        ann_file=f'{data_root}/annotations/new_184x256/184x256__val_clamped2_33242.json',
        img_prefix=f'{data_root}/2-feature/',
        data_cfg=data_cfg,
